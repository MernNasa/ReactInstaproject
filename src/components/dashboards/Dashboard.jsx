    ...
    <div className="h-[89vh] flex bg-gray-100">
      <aside className="w-[18%] h-full bg-white shadow-lg dark:bg-gray-600 dark:text-white">
        ...
        <nav className="p-4 space-y-2">
          ...
          <Link to={`/dashboard/updateprofile/${activeUser.fullname}`} className="w-full text-left px-4 py-2 rounded-lg hover:bg-indigo-50 text-gray-700 font-medium flex items-center gap-3">
